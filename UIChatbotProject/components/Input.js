...
class Input extends React.Component {
  ...
  render(){
    ...
    return(
     ...
     style={styles.input}  onChangeText={(TextInputValue)=>{ this.OnInputText(TextInputValue) }}
     >
      </TextInput>    
      
   <IconButton style={styles.micro} icon="microphone-outline" color={Colors.white} size={25} onPress={() => alert('Pressed')}/> 
  </View>
  )
}
}
